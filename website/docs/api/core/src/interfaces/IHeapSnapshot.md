...
[IHeapNode](IHeapNode.md) and [IHeapEdge](IHeapEdge.md).
...
The constructor name of the object instance

#### Returns

[`Nullable`](../type-aliases/Nullable.md)\<[`IHeapNode`](IHeapNode.md)\>

a handle pointing to any one of the object instances, returns
...
id of the heap node (JS object in heap) you would like to query

#### Returns

[`Nullable`](../type-aliases/Nullable.md)\<[`IHeapNode`](IHeapNode.md)\>

the API returns `null` if no heap object has the specified id.
...
id array of the heap nodes (JS objects in heap) you
would like to query
...
an array of those heap nodes. The return array will preserve the
...
id set of the heap nodes (JS objects in heap) you
would like to query

#### Returns

`Set`\<[`IHeapNode`](IHeapNode.md)\>

a set of those heap nodes. The set will only include
...
`true` if there is at least one such object in the heap
...
marker name on the object instances tagged by [tagObject](../functions/tagObject.md)
