...
[getSnapshotFileForAnalysis](../variables/getSnapshotFileForAnalysis.md), [loadHeapSnapshot](../variables/loadHeapSnapshot.md),
or [snapshotMapReduce](../variables/snapshotMapReduce.md).
