...
## Technical Overview Talk

[MemLab: Automating Memory Leak Detection and Heap Analysis](https://gitnation.com/contents/memlab-automating-memory-leak-detection-and-heap-analysis),
presented at JSNation 2026.

<div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', maxWidth: '100%' }}>
  <iframe
    title="MemLab: Automating Memory Leak Detection and Heap Analysis (JSNation 2026)"
    src="https://player.vimeo.com/video/1197674483?title=0&byline=0&portrait=0"
